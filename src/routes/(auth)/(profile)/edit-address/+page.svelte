                    ...
                    <div class="account-nav flex-grow-1">
                        ...
                        <ul>
                            ...
                            <li class="account-nav__item account-nav__item--active"><a
                                    href="account-edit-address.html">Edit Address</a></li>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters">
                                <div class="col-12 col-lg-10 col-xl-8">
                                    ...
                                    <div class="form-group"><label for="checkout-company-name">Company Name
                                    ...
                                    <div class="form-group"><label for="checkout-street-address">Street
                                            ...
                                            id="checkout-street-address" placeholder="Street Address"></div>
                                    <div class="form-group"><label for="checkout-address">Apartment, suite, unit
                                            etc. <span class="text-muted">(Optional)</span></label> <input
                                            type="text" class="form-control" id="checkout-address"></div>
                                    <div class="form-group"><label for="checkout-city">Town / City</label>
                                        <input type="text" class="form-control" id="checkout-city"></div>
                                    <div class="form-group"><label for="checkout-state">State / County</label>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6"><label
                                                ...
                                                class="form-control" id="checkout-phone" placeholder="Phone">
                                        </div>
                                    </div>
