<script>
	import Card from '$lib/components/MiniProductCard.svelte';
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item">
						...
						<svg class="breadcrumb-arrow" width="6px" height="9px"
							><use xlink:href="/img/sprite.svg#arrow-rounded-right-6x9"></use></svg
						>
					</li>
					<li class="breadcrumb-item">
					...
					<div class="product-gallery">
						<div class="product-gallery__featured">
							...
							<div class="owl-carousel" id="product-image">
								<a href="/src/lib/images/products/phone-5.jpg" target="_blank"
									><img src="/src/lib/images/products/phone-5.jpg" alt="" />
								</a><a href="/src/lib/images/products/phone-5.jpg" target="_blank"
									><img src="/src/lib/images/products/phone-5.jpg" alt="" />
								</a>
								<a href="/src/lib/images/products/phone-5.jpg" target="_blank"
									><img src="/src/lib/images/products/phone-5.jpg" alt="" />
									...
									><img src="/src/lib/images/products/phone-5.jpg" alt="" /></a
								>
							</div>
						</div>
						<div class="product-gallery__carousel">
							<div class="owl-carousel" id="product-carousel">
								<a
									href="/src/lib/images/products/phone-5.jpg"
									class="product-gallery__carousel-item"
									><img
										class="product-gallery__carousel-image"
										src="/src/lib/images/products/phone-5.jpg"
										alt=""
									/>
								</a><a
									href="/src/lib/images/products/phone-5.jpg"
				...
				<div class="product__info">
					...
					<div class="product__rating">
						...
						<div class="product__rating-legend">
							<a href="javascript;:">7 Reviews</a><span>/</span><a href="javascript;:"
								>Write A Review</a
							>
						</div>
					</div>
				...
				<div class="product__sidebar">
					...
					<form class="product__options">
						<div class="form-group product__option">
							<label for="" class="product__option-label">Color</label>
							<div class="input-radio-color">
								<div class="input-radio-color__list">
									<label
										...
										style="color: #fff;"
										data-toggle="tooltip"
										title="White"><input type="radio" name="color" /> <span></span></label
									>
									<label
										class="input-radio-color__item"
										style="color: #ffd333;"
										data-toggle="tooltip"
										title="Yellow"><input type="radio" name="color" /> <span></span></label
									>
									<label
										class="input-radio-color__item"
										style="color: #ff4040;"
						...
						<div class="form-group product__option">
							<label for="" class="product__option-label">Material</label>
				...
				<div class="product__footer">
					<div class="product__tags tags">
						<div class="tags__list">
							<a href="javascript;:">Mounts</a> <a href="javascript;:">Electrodes</a>
							<a href="javascript;:">Chainsaws</a>
						</div>
					</div>
			...
			<div class="product-tabs__content">
				<div class="product-tabs__pane product-tabs__pane--active" id="tab-description">
					<div class="typography">
						...
						<p>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas fermentum, diam non
							iaculis finibus, ipsum arcu sollicitudin dolor, ut cursus sapien sem sed purus. Donec
							vitae fringilla tortor, sed fermentum nunc. Suspendisse sodales turpis dolor, at
							rutrum dolor tristique id. Quisque pellentesque ullamcorper felis, eget gravida mi
							elementum a. Maecenas consectetur volutpat ante, sit amet molestie urna luctus in.
							Nulla eget dolor semper urna malesuada dictum. Duis eleifend pellentesque dui et
							finibus. Pellentesque dapibus dignissim augue. Etiam odio est, sodales ac aliquam id,
							iaculis eget lacus. Aenean porta, ante vitae suscipit pulvinar, purus dui interdum
						...
						<p>
							...
							ipsum risus ac neque. Morbi eu facilisis purus. Quisque mi tortor, cursus in nulla ut,
							laoreet commodo quam. Pellentesque et ornare sapien. In ac est tempus urna tincidunt
							finibus. Integer erat ipsum, tristique ac lobortis sit amet, dapibus sit amet purus.
							Nam sed lorem nisi. Vestibulum ultrices tincidunt turpis, sit amet fringilla odio
							scelerisque non.
						</p>
					</div>
				</div>
				<div class="product-tabs__pane" id="tab-specification">
					<div class="spec">
						...
						<div class="spec__disclaimer">
							...
							and the appearance of the goods is for reference only and is based on the latest
										...
										<div class="review">
											...
											<div class="review__content">
												...
												<div class="review__text">
													...
													maximus ut lectus. Vivamus commodo scelerisque lacus, at porttitor dui
									...
									<li class="reviews-list__item">
										<div class="review">
											...
											<div class="review__content">
												...
												<div class="review__text">
													Aenean non lorem nisl. Duis tempor sollicitudin orci, eget tincidunt ex
													semper sit amet. Nullam neque justo, sodales congue feugiat ac, facilisis
													a augue. Donec tempor sapien et fringilla facilisis. Nam maximus
													consectetur diam. Nulla ut ex mollis, volutpat tellus vitae, accumsan
													ligula.
												</div>
									...
									<li class="reviews-list__item">
										<div class="review">
											...
											<div class="review__content">
												...
												<div class="review__text">
													Duis ac lectus scelerisque quam blandit egestas. Pellentesque hendrerit
...
<Carousel sectionName="Related Product">
	<Card />
</Carousel>
