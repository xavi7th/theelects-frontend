    ...
    <div class="page-header__container container">
        <div class="page-header__breadcrumb">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript;:">Home</a> <svg class="breadcrumb-arrow" width="6px" height="9px"><use xlink:href="/img/sprite.svg#arrow-rounded-right-6x9"></use></svg></li>
                    <li class="breadcrumb-item"><a href="javascript;:">Breadcrumb</a> <svg class="breadcrumb-arrow" width="6px" height="9px"><use xlink:href="/img/sprite.svg#arrow-rounded-right-6x9"></use></svg></li>
                ...
                <div class="product-tabs__pane product-tabs__pane--active" id="tab-description">
                    <div class="typography">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas fermentum, diam
                            ...
                            molestie urna luctus in. Nulla eget dolor semper urna malesuada dictum.
                            Duis eleifend pellentesque dui et finibus. Pellentesque dapibus dignissim augue.
                            Etiam odio est, sodales ac aliquam id, iaculis eget lacus. Aenean porta, ante
                            vitae suscipit pulvinar, purus dui interdum tellus, sed dapibus mi mauris
                            vitae tellus.</p>
                        ...
                        <p>Praesent mattis eget augue ac elementum. Maecenas vel ante ut enim mollis
                            ...
                            in, vehicula
                            eu elit. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
                            posuere cubilia Curae; Curabitur porta vulputate augue, at sollicitudin nisl
                            molestie eget.</p>
                        <p>Nunc sollicitudin, nunc id accumsan semper, libero nunc aliquet nulla, nec
                            ...
                            est
                            tempus urna tincidunt finibus. Integer erat ipsum, tristique ac lobortis sit
                                                ...
                                                <div class="review__rating">
                                                    <div class="rating">
                                                        <div class="rating__body"><svg
                                                                ...
                                                                <g class="rating__fill">
                                                                    <use
                                                                        xlink:href="/img/sprite.svg#star-normal">
                                                                    </use>
                                                                </g>
                                                                <g class="rating__stroke">
                                                                    <use
                                                                        xlink:href="/img/sprite.svg#star-normal-stroke">
                                                                    </use>
                                                                </g>
                                                            </svg>
                                                            <div
                                        ...
                                        <div class="review">
                                            ...
                                            <div class="review__content">
                                                ...
                                                <div class="review__text">Aenean non lorem nisl. Duis tempor
                                                    ...
                                                    volutpat tellus vitae, accumsan ligula.</div>
                                    ...
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item disabled"><a
                                                ...
                                                aria-label="Previous"><svg
                                                    ...
                                                    <use
                                                        xlink:href="/img/sprite.svg#arrow-rounded-left-8x13">
                                                    </use>
                                                </svg></a></li>
                                        ...
                                        <li class="page-item"><a class="page-link page-link--with-arrow"
                                                href="javascript;:bind:" aria-label="Next"><svg
                                                    ...
                                                    aria-hidden="true" width="8px" height="13px">
                                                    <use
                                                        xlink:href="/img/sprite.svg#arrow-rounded-right-8x13">
                                                    </use>
                                                </svg></a></li>
                                    </ul>
                                </div>
