...
<div class="block-product-columns__item">
  <div class="product-card product-card--layout--horizontal">
    ...
    <div class="product-card__badges-list">
      {#if tag}
      <div class="product-card__badge { tag == 'sale' ? 'product-card__badge--sale' : tag == 'new' ? 'product-card__badge--new' : tag == 'hot' ? 'product-card__badge--hot' : ''}">{tag}</div>
      {/if}
    </div>
    <div class="product-card__image">
      <a href="product.html"><img src="/src/lib/images/products/product-4.jpg" alt="" /></a>
    </div>
