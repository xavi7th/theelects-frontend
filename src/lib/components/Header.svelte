                ...
                <div class="menu menu--layout--topbar">
                  ...
                  <ul class="menu__list">
                    ...
                    <li class="menu__item">
                      <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                      <div class="menu__item-submenu-offset"></div>
                      <a class="menu__item-link" href="javascript;:">{`${currency.sign} ${currency.name}`}</a>
                    </li>
                    {/each}
                  </ul>
                </div>
                    ...
                    <li class="menu__item">
                      ...
                      <a class="menu__item-link" href="javascript;:">
                        <div class="menu__item-icon">
                          <img srcset="{language.icon}" src="{language.icon_subset}" alt="{language.name}" />
                        </div>
                        {language.name}
                      </a>
                    </li>
        ...
        <div class="nav-panel__container container">
          <div class="nav-panel__row">
            <div class="nav-panel__departments">
              <!-- .departments -->
              <div class="departments departments--open" data-departments-fixed-by=".block-slideshow">
                <div class="departments__body">
                  <div
                    class="departments__links-wrapper"
                    style="height: 415px; max-height: {$side_menu.is_open? '415px' : '0'} transition: max-height 500ms ease;"
                  >
                      ...
                      <ul class="departments__links">
                        ...
                        <li class="departments__item">
                          <a class="departments__item-link" href="{side_nav.url}">
                            {side_nav.name} {#if side_nav.sub_menu}
                          ...
                          <div class="departments__submenu departments__submenu--type--megamenu departments__submenu--size--xl">
                            ...
                            <div class="megamenu megamenu--departments">
                              <div class="megamenu__body" style="background-image: url('/src/lib/images/megamenu/megamenu-1.jpg');">
                                <div class="row">
                                  {#each side_nav.sub_menu_list as sub_menu (sub_menu.id)} {#if sub_menu.layout == 1}
                                  <div class="col-3">
                              ...
                              <ul class="menu__list">
                                ...
                                <li class="menu__item">
                                  ...
                                  <a class="menu__item-link" href="{sub_menu.url}">
                                    {sub_menu.name} {#if sub_menu.inner_sub}
                                    ...
                                    <div class="menu menu--layout--classic">
                                      ...
                                      <ul class="menu__list">
                                        ...
                                        <li class="menu__item">
                                          <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                          <div class="menu__item-submenu-offset"></div>
                                          <a class="menu__item-link" href="{drop_menu.url}">{drop_menu.name}</a>
                                        </li>
                                        {/each}
                                      </ul>
                                    </div>
                ...
                <button class="departments__button" on:click="{toggle_side_menu}">
                  ...
                  Shop By Category
                  <svg class="departments__button-arrow" style="transform: rotate({$side_menu.is_open ? '0deg': '180deg'}); transition: transform 500ms;" width="9px" height="6px">
            ...
            <div class="nav-panel__nav-links nav-links">
              <ul class="nav-links__list">
                {#each navigation as nav (nav.id)} {#if nav.layout == 1}
                <li class="nav-links__item nav-links__item--has-submenu">
                  <a class="nav-links__item-link" href="{nav.url}">
                    <div class="nav-links__item-body">
                      {nav.name} {#if nav.sub_menu}
            ...
            <div class="nav-panel__indicators">
              ...
              <div class="indicator">
                ...
                <div
                  ...
                  style="display: flex; justify-content: right; position: fixed; width: 100vw; height: 100vh; background: #00000085; top: 0; left: 0; transform: scale({cart_is_open ? 1: 0}); z-index: 99999;"
                >
                  <div style="display: flex; width: 350px; height: 100%; background: white; position: relative; flex-direction: column; transform: translateX({cart_list_is_open ? '0px': '500px'}); transition: transform 500ms linear;">
                    <div style="width: 100%;">
                      <div>
                        <h3 class="block-header__title" style="display: flex; color: black; justify-content: space-between; padding: 10px 15px; padding-bottom: 0px;">
                          Shopping Cart
                          <button type="button" on:click="{toggle_cart}" class="dropcart__product-remove btn btn-light btn-sm btn-svg-icon">
                            <svg width="20px" height="20px">
                    ...
                    <div class="cart__product-item" style="padding: 15px; overflow: auto;">
                      <div class="dropcart__product">
                        <div class="dropcart__product-image">
                          <a href="product.html"><img src="/src/lib/images/products/phone-10.jpg" alt="" /></a>
                        </div>
