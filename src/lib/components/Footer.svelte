        ...
        <div class="row">
            ...
            <div class="site-footer__widget footer-links">
              ...
              <ul class="footer-links__list">
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">About Us</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Delivery Information</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Privacy Policy</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Brands</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Contact Us</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Returns</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Site Map</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-6 col-md-3 col-lg-2">
            <div class="site-footer__widget footer-links">
              ...
              <ul class="footer-links__list">
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Store Location</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Order History</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Wish List</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Newsletter</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Specials</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Gift Certificates</a>
                </li>
                <li class="footer-links__item">
                  <a href="javascript;:" class="footer-links__link">Affiliate</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-12 col-md-12 col-lg-4">
            <div class="site-footer__widget footer-newsletter">
              ...
              <ul class="footer-newsletter__social-links">
                ...
                <li>
                  <a href="https://www.geo-tag.de" title="This page contains geo-tags">
                    <img src="https://www.geo-tag.de/icon/geotag_l.png" width="97" height="32" style="border-style:none; margin-left: 10px;" alt="This page contains geo-tags" />
                  </a>
                </li>
              </ul>
            </div>
