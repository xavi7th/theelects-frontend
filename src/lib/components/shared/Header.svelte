<script lang="ts">
    ...
    const toggle_side_menu = () => side_menu_is_open = !side_menu_is_open;
</script>
                    ...
                    <div class="topbar__row">
                                    ...
                                    <div class="menu menu--layout--topbar">
                                        ...
                                        <ul class="menu__list">
                                            ...
                                            <li class="menu__item">
                                                <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                <div class="menu__item-submenu-offset"></div><a
                                                    class="menu__item-link" href="javacript;:">Logout</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- .menu / end -->
                        ...
                        <div class="topbar__item">
                            <div class="topbar-dropdown"><button class="topbar-dropdown__btn"
                                    type="button">Currency: <span class="topbar__item-value">NGN</span> <svg
                                        ...
                                        <ul class="menu__list">
                                            {#each $header_currencies as currency (currency.country)}
                                                <li class="menu__item">
                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                    <div class="menu__item-submenu-offset"></div><a
                                                        class="menu__item-link" href="javascript;:">{ `${currency.sign} ${currency.name}` }</a>
                                                </li>                                               
                                            {/each}
                                        </ul>
                                    </div>
                                                ...
                                                <li class="menu__item">
                                                    ...
                                                    <a class="menu__item-link" href="javascript;:">
                                                        <div class="menu__item-icon"><img
                                                            ...
                                                            src="{language.icon_subset}" alt="{language.name}"></div>
                                                            {language.name}
                                                    </a>
                                                </li>
                                            {/each}
                    ...
                    <div class="nav-panel__container container">
                        <div class="nav-panel__row">
                                ...
                                <div class="departments departments--open departments--fixed"
                                    ...
                                    <div class="departments__body">
                                        <div class="departments__links-wrapper" 
                                            style="
                                                max-height: {side_menu_is_open ? '900px' : '0'};
                                                                                            ...
                                                                                            <ul
                                                                                                ...
                                                                                                {:else}
                                                                                                    <li class="megamenu__item">
                                                                                                        <a
                                                                                                            href="javascript;:">{sub_menu.name}</a>
                                                                                                        </li>
                                                                                                {/if}
                                                                                            </ul>
                                                                                        </div>
                                                                                            ...
                                                                                            <ul
                                                                                                ...
                                                                                                <li
                                                                                                    ...
                                                                                                    <ul
                                                                                                        ...
                                                                                                        {#each sub_menu.drop_menu as drop_menu (drop_menu.name)}
                                                                                                            <li class="megamenu__item"><a
                                                                                                                    href="javascript;:">Screwdrivers</a>
                                                                                                            </li>
                                                                                                        {/each}
                                                                                                    </ul>
                                                                                                </li>
                                                                        ...
                                                                        <ul class="menu__list">
                                                                            {#each side_nav.sub_menu_list as sub_menu (sub_menu.id)}
                                                                                <li class="menu__item">
                                                                                    <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                                    <div class="menu__item-submenu-offset"></div><a
                                                                                        class="menu__item-link" href="{sub_menu.url}">{sub_menu.name} 
                                                                                        {#if sub_menu.inner_sub}
                                                                                                    ...
                                                                                                    {#each sub_menu.drop_menu as drop_menu (drop_menu.name)}
                                                                                                        <li class="menu__item">
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                href="{drop_menu.url}">{drop_menu.name}</a>
                                                                                                        </li>
                                                                                                    {/each}
                                                                                                </ul>
                                                                                            </div>
                                    ...
                                    <button class="departments__button" on:click={toggle_side_menu}><svg class="departments__button-icon"
                                            width="18px" height="14px">
                                            <use xlink:href="images/sprite.svg#menu-18x14"></use>
                                        </svg> Shop By Category <svg class="departments__button-arrow" 
                                            style="
                                                transform: rotate({side_menu_is_open ? '0deg' : '180deg'});
                                        ...
                                        {#if nav.layout == 1}
                                            <li class="nav-links__item nav-links__item--has-submenu">
                                                <a class="nav-links__item-link" href="index.html">
                                                    <div class="nav-links__item-body">{nav.name} 
                                                        {#if nav.sub_menu}
                                                            <svg
                                                            ...
                                                            <ul class="menu__list">
                                                                {#each nav.sub_menu_list as sub_menu (sub_menu.name)}
                                                                    <li class="menu__item">
                                                                        <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                                        <div class="menu__item-submenu-offset"></div><a
                                                                            class="menu__item-link" href="{sub_menu.url}">{sub_menu.name}</a>
                                                                    </li>
                                                                {/each}
                                                            </ul>
                                                        </div>
                            ...
                            <div class="nav-panel__indicators">
                                ...
                                <div class="indicator"><button on:click={toggle_cart}
                                        class="indicator__button"><span class="indicator__area"><svg width="20px"
                                                height="20px">
                                                <use xlink:href="images/sprite.svg#cart-20"></use>
                                            </svg> <span class="indicator__value">3</span></span></button>
                                        {#if cart_is_open}
                                            ...
                                            >
                                                <div 
                                                    style="
                                                        ...
                                                        transform: translateX({cart_list_is_open ? '0px' : '500px'});
                                                ...
                                                >
                                                    <div style="width: 100%;">
                                                        <div>
                                                            ...
                                                            ">
                                                                Shopping Cart
                                                                <button type="button" on:click={toggle_cart}
                                                    ...
                                                    <div class="cart__product-item" style=" padding: 15px; overflow: auto;">
                                                        <div class="dropcart__product">
                                                            ...
                                                            <div class="dropcart__product-info">
                                                                <div class="dropcart__product-name" style="color: black"><a
                                                                ...
                                                                <div class="dropcart__product-meta" style="color: black"><span
