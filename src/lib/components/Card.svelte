<div class="block-products-carousel__column">
    <div class="block-products-carousel__cell">
        <div class="product-card"><button class="product-card__quickview" type="button">
            ...
            <div class="product-card__image"><a href="/shop/1">
                <img src="/images/products/product-1.jpg" alt=""></a>
            </div>
            <div class="product-card__info">
                <div class="product-card__name">
                    <a href="/shop/1">Electric Planer Brandix KL370090G 300 Watts</a>
                </div>
